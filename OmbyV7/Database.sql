...
CREATE TABLE Transaction(
    IdAcheteur NUMBER NOT NULL,
    CONSTRAINT AcheteurFK FOREIGN KEY (IdAcheteur) REFERENCES Olona(Id),
    IdVendeur NUMBER NOT NULL,
    CONSTRAINT VendeurFK FOREIGN KEY (IdVendeur) REFERENCES Olona(Id),
    IdOmby NUMBER NOT NULL,
    CONSTRAINT OmbyFK FOREIGN KEY (IdOmby) REFERENCES Omby(Id),
    ArgentTransfere NUMBER NOT NULL,
    DATETRANSFER DATE
);
